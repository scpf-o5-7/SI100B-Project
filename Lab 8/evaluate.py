...
def evaluate_model(model_path: str = None, save_plots: bool = True):
    ...
    def calculate_metrics(preds, targets, probs, dataset_name: str):
        ...
        print(f"Number of detected actual classes: {actual_num_classes}")
        print(f"Actual classes: {actual_class_names}")

        accuracy = accuracy_score(targets, preds)

        recall_per_class = recall_score(
            targets, preds, average=None, labels=unique_classes
        )
        recall_macro = recall_score(
            targets, preds, average="macro", labels=unique_classes
        )
        recall_weighted = recall_score(
            targets, preds, average="weighted", labels=unique_classes
        )
    ...
    train_metrics = calculate_metrics(
        train_preds, train_targets, train_probs, "Training"
    )
    ...
    if save_plots:
        ...
        plot_confusion_matrix(
            ...
            classes=train_metrics["actual_class_names"],
        ...
        plot_confusion_matrix(
            ...
            classes=val_metrics["actual_class_names"],
